export const Bio = {
  ...
  github: "https://github.com/Bhumi-Maru",
  resume: "https://drive.google.com/drive/my-drive",
  linkedin: "https://www.linkedin.com/in/bhumi-maru/",
  github: "https://github.com/Bhumi-Maru",
};
...
export const skills = [
  {
    ...
    skills: [
      ...
      // {
      //   name: "Redux",
      //   image: "https://i.imghippo.com/files/zelnM1728549836.png",
      // },
    ],
  },
  {
...
export const education = [
  {
    ...
    desc: "I am pursuing a Bachelor's of Computer Applications at Swarrnim Startup & Innovation University, Gandhinagar. I am currently in my 5th semester. I have also taken a Full Stack Web Development course at Red & White Multimedia Education.",
  ...
  },
  {
    ...
    date: "2022 - 2023",
    grade: "85.43%",
    desc: "I have completed my 12th standard at Dipak Shikshan Sankul, Ahmedabad.",
  },
  {
    id: 2,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKv4wSS6C_HNhAExR41GiSVzVS5Y_pgewbJBdYLyxp4g&usqp=CAE&s",
    ...
    date: "2020 - 2021",
    grade: "95.16%",
    desc: "I have completed my 10th standard at Dipak Shikshan Sankul, Ahmedabad.",
  },
];
...
export const projects = [
  {
    id: 0,
    title: "Hindustan Gold-ERP Management System",
    // date: "July - 2024",
    description:
      "Developed a robust Procurement ERP System that streamlines the complete purchasing workflow—from Purchase Indent (PI) to Purchase Order (PO) and finally Goods Receipt (GRN). The system includes role-based access control, multi-level approval hierarchies, and vendor management, ensuring secure, transparent, and well-structured operations across departments. I built a highly modular Admin Panel using React.js integrated with Laravel REST APIs, providing a smooth, responsive, and intuitive user experience. The platform automates approval processes, improves procurement accuracy, and enhances organizational efficiency.",
    image: "/Images/hindustan.png",
    tags: ["ReactJS", "Bootstrap", "Laravel", "MySQL"],
    github: "https://github.com/BhumiMaru/Hindustan_Gold",
    webapp: "https://hindustan.innovativeeshop.in/",
  },
  {
    id: 1,
    ...
    // date: "July - 2024",
    description:
      "Developed a responsive e-commerce platform featuring real-time cart updates, product variants, and secure checkout using React.js, Node.js, Express.js, and MongoDB. Built RESTful APIs with JWT authentication and refresh tokens for secure product and order management. Implemented a no-code admin panel that allows non-technical users to manage products, inventory, pricing, categories, and orders without modifying the codebase. Enhanced overall scalability and performance through server-side pagination, lazy loading, and efficient database indexing.",
    image: "/Images/E-Commerce.png",
    tags: ["ReactJS", "NodeJS", "ExpressJS", "NoSQL"],
    github: "https://github.com/BhumiMaru/Kyan-E-commerce-Website",
  ...
  },
  {
    ...
    tags: ["React Js"],
    github: "https://github.com/Bhumi-Maru/unsplash-clone?tab=readme-ov-file",
  ...
  },
  {
    ...
    tags: ["React Js"],
    github: "https://github.com/Bhumi-Maru/Quiz-App?tab=readme-ov-file",
    webapp: "https://quiz-app-by-maru.netlify.app/",
  },

  {
    ...
    date: "",
    description:
      "This React Todo application allows users to add, update, and delete tasks, with state management handled by hooks like useState and useEffect. The app stores tasks in the browser's localStorage, ensuring that the task list persists even after the page is refreshed. Users can type tasks into an input field, add them to the list, and edit or delete tasks directly from the displayed list. The app is styled with CSS, featuring a background image, clean typography, and modern button designs, creating a simple and user-friendly interface.",
    image: "/Images/Todo-app.png",
    tags: ["React Js"],
    github: "https://github.com/Bhumi-Maru/Todo-App",
  ...
  },
  {
    ...
    image: "/Images/alarm-clock-app.png",
    tags: ["React Js"],
    github: "https://github.com/Bhumi-Maru/Alarm-Clock-App",
  ...
  },
  {
    ...
    github: "https://github.com/Bhumi-Maru/Movie-App",
  ...
  },
  {
    ...
    tags: ["HTML", "CSS", "JavaScript"],
    github: "https://github.com/Bhumi-Maru/Weather-App",
  ...
  },
  {
    ...
    image: "/Images/Count-Down-App.png",
    tags: ["HTML", "CSS", "JavaScript"],
    github:
      "https://github.com/Bhumi-Maru/Count-Down-App/tree/main/Count-Down%20App",
  ...
  },
  {
    ...
    image: "/Images/Cactus-plant-website.png",
    tags: ["HTML", "CSS", "JavaScript"],
    github: "https://github.com/Bhumi-Maru/Cactus-Website",
  ...
  },
  {
    ...
    image: "/Images/EduFord.png",
    tags: ["HTML", "CSS"],
    github: "https://github.com/Bhumi-Maru/Eduford",
    webapp: "https://eduford-by-maru.netlify.app/",
  },
  // {
  //   id: 1,
  //   title: "Bootstrap Portfolio",
  //   description:
  //     "This portfolio website is a sleek and modern platform designed to showcase personal or professional work. Built with HTML, CSS, Bootstrap, and JavaScript, it features a responsive layout that adapts seamlessly to different devices. The homepage includes a visually appealing hero section with smooth scrolling navigation. Bootstrap's grid system is used to organize project galleries, skillsets, and testimonials in a clean and structured way. Interactive elements, such as hover effects and animations, enhance the user experience.",
  //   image: "https://i.imghippo.com/files/KtKgC1726730496.png",
  //   tags: ["HTML", "CSS", "BootStrap"],
  //   github: "https://github.com/Bhumi-Maru/Portfolio",
  //   webapp: "https://bootstrap-portfolio-by-maru.netlify.app/",
  // },
];
